...
//        bookGrpcService.create(bookMapper.toRequest(EXAMPLE_BOOK));
//
...
//        StreamRecorder<BookDto> responseObserver = StreamRecorder.create();
//
//        bookGrpcService.getAll(bookMapper.toRequest(EXAMPLE_BOOK), responseObserver);
//
//        if (!responseObserver.awaitCompletion(5, TimeUnit.SECONDS)) {
//            fail("The call did not terminate in time");
//        }
...
//        bookGrpcService.getAll(BookRequest.getDefaultInstance(), responseObserver);
//        if (!responseObserver.awaitCompletion(5, TimeUnit.SECONDS)) {
//            fail("The call did not terminate in time");
//        }
//        assertNull(responseObserver.getError());
